...
func main() {
	...
	fmt.Println("🤖 Coding Agent Workshop - Command Runner")
	fmt.Println("Now Claude can read files, list directories, AND run shell commands!")
	fmt.Println("Try: 'Run git status' or 'List all .go files using bash'")
